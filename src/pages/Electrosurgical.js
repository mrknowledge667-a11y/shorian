...
const Electrosurgical = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const rows = await fetchProductsByCategorySlug('electrosurgical', currentLanguage);
    ...
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ py: 8, backgroundColor: '#f9f9f9', flex: 1 }}>
        <Container maxWidth="xl">
          ...
          >
            {t('category.electrosurgical.title', 'Electrosurgical Equipment')}
          </Typography>
...
export default Electrosurgical;