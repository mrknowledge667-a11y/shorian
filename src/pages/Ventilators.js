...
const Ventilators = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const rows = await fetchProductsByCategorySlug('ventilators', currentLanguage);
    ...
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ py: 8, backgroundColor: '#f9f9f9', flex: 1 }}>
        <Container maxWidth="xl">
          ...
          >
            {t('category.ventilators.title', 'Ventilators & Respiratory Equipment')}
          </Typography>
