// src/pages/EndoscopyLaparoscopy.js
...
const EndoscopyLaparoscopy = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const rows = await fetchProductsByCategorySlug('endoscopy-laparoscopy', currentLanguage);
    ...
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ py: 8, backgroundColor: '#f9f9f9', flex: 1 }}>
        <Container maxWidth="xl">
          ...
          >
            {t('category.endoscopy_laparoscopy.title', 'Endoscopy & Laparoscopy Equipment')}
          </Typography>
...
export default EndoscopyLaparoscopy;